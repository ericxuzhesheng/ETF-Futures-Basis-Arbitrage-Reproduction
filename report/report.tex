...
区间，\textbf{多品种复合年化 5.1\%、夏普 1.59、最大回撤 $-$3.2\%}，与银河期货报告的
...
$r_0/244$ 逐日累计；闲置资金按 $r_f=2\%$ 计息（银河口径）。成本区分两个口径：
...
\midrule
IH+50ETF   & \pct{5.2} & \textit{\pct{3.8}} & 1.43 & $-$\pct{3.6} & \pct{61} \\
IF+300ETF  & \pct{4.7} & \textit{\pct{5.8}} & 1.07 & $-$\pct{4.8} & \pct{62} \\
IC+500ETF  & \pct{7.0} & \textit{\pct{4.7}} & 1.65 & $-$\pct{4.6} & \pct{61} \\
IM+1000ETF & \pct{6.8} & \textit{\pct{1.9}} & 1.41 & $-$\pct{4.1} & \pct{64} \\
\midrule
\textbf{多品种复合} & \textbf{\pct{5.1}} & \textit{\pct{6.6}}
  & \textbf{1.59} & $\mathbf{-}$\textbf{\pct{3.2}} & \pct{59} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{分散度最大的 IM（小盘）}上提升最明显（年化 6.8\%$\to$7.5\%，夏普 1.41$\to$1.60），
...
品种 & 年化 & 夏普 & 年化 & 夏普 \\
\midrule
IH+50ETF   & \pct{5.2} & 1.43 & \pct{5.2} & 1.43 \\
IF+300ETF  & \pct{4.7} & 1.07 & \pct{4.7} & 1.05 \\
IC+500ETF  & \pct{7.0} & 1.65 & \pct{7.1} & 1.66 \\
IM+1000ETF & \pct{6.8} & 1.41 & \textbf{\pct{7.5}} & \textbf{1.60} \\
\midrule
\textbf{复合} & \pct{5.1} & 2.62 & \textbf{\pct{5.2}} & \textbf{2.68} \\
\bottomrule
\end{tabular}
\end{table}
